...
_ext_src_root = f"hilbertcurve_ops/_ext-src"
...
setup(
    ...
    ext_modules=[
        CUDAExtension(
            name="hilbertcurve_ops._ext",
            sources=_ext_sources,
            extra_compile_args={"cxx": ["-O3"], "nvcc": ["-O3", "-Xfatbin", "-compress-all"]},
            include_dirs=[f"{this_dir}/{_ext_src_root}/include"],
        )
    ],
